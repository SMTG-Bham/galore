...
class test_get_cross_sections_from_data_table(unittest.TestCase):
    ...
    # check the function goes well with above datatable
        cross_sections_scofield, _ = _cross_sections_from_csv_data(
            800, data, 'Scofield')
    ...
    # check the function goes well with above datatable
        cross_sections_yeh, _ = _cross_sections_from_csv_data(800, data, 'Yeh')
        self.assertAlmostEqual(cross_sections_yeh['s'], 0.00145)
...
class test_datafile_path(unittest.TestCase):
    ...
    def test_scofield_directory_and_path(self):
        ...
        correct_path = os.path.join(
            correct_directory, 'Scofield_csv_database.zip')
    ...
    def test_yeh_directory_and_path(self):
        ...
        correct_path = os.path.join(
            correct_directory, 'Yeh_Lindau_1985_Xsection_CSV_Database.zip')
