...
class test_process_pdos(unittest.TestCase):
    ...
    def test_lorentzian(self):
        self.assertAlmostEqual(galore.lorentzian(3., f0=1, fwhm=(3 * 2.35482)),0.068238617255)
    ...
    def test_broaden(self):
        ...
        assert_array_almost_equal(galore.broaden(broadened_data, d = 2 , dist='lorentzian', width=lorentzian),
        np.array([0.00595715, 1.60246962, 3.19897467, 4.7825862 , 0.01190685, 0.    ]))
